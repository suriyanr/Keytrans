...
2. Language and layout are changable to suit the knowledgable end user,
   who can edit the map file, in Notepad.
...
(2) github, sarovar.org (now defunct) for hosting this package.

Warranty:
---------
This is a freeware without any implicit or explicit warranty of anykind. You use it at your own risk.

Source: Available at github, sarovar.org (defunct)
